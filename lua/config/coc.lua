...
keyset("n", "<leader>grt", "<Plug>(coc-type-definition)", {silent = true}) -- "gy" in coc example
keyset("n", "<leader>gri", "<Plug>(coc-implementation)", {silent = true}) -- "gi" in coc example
keyset("n", "<leader>grr", "<Plug>(coc-references)", {silent = true}) --  "gr" in coc example
...
-- Symbol renaming
keyset("n", "<leader>grn", "<Plug>(coc-rename)", {silent = true}) --  "<leader>rn" in coc example
